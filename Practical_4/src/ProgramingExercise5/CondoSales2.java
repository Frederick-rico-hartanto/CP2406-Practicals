...
public class CondoSales2 {
    ...
    public static void fetchViewChoice() //Get the view choice and send it to the processing method.
    {
        options = "";
        System.out.println("=========================");
    ...
    public static void fetchParkingChoice() //Get the parking choice and send it to the processing method.
    {
    ...
    public static void fetchCounterTopChoice() //Get the granite counter top choice and send it to the processing method.
    {
    ...
    public static void fetchConstructionChoice() //Get the expedited construction choice and send it to the processing method.
    {
